    ...
    return(
        <>
            <main>    
                ...
                <div className="flex flex-row items-center align-center justify-center space-x-8 my-12">
                    <div className="w-[360px] bg-zinc-400 rounded-xl py-8 px-8 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 h-[480px]">
                        <h1 className="text-2xl font-bold text-white mb-4">Our Story</h1>
                        <p className="text-white font-semibold mb-4">Founded in 2020, Liggen has grown from a small startup to a trusted financial partner for millions of users worldwide. Our journey is driven by the belief that everyone deserves access to modern banking solutions.</p>
                    ...
                    <div className="w-[360px] bg-zinc-400 rounded-xl p-4 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 h-[480px]">
                        ...
                        <div className="mt-8">
                            <div className=" text-white bg-zinc-400 rounded-xl p-4 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 h-fit mb-4 space-y-2">
                                ...
                                <p className="text-sm font-semibold">Constantly pushing the boundaries of what's possible in digital banking</p>
                            </div>
                            <div className=" text-white bg-zinc-400 rounded-xl p-4 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 h-fit mb-4 space-y-2">
                                <h2 className="font-bold text-lg">Security</h2>
                                <p className="text-sm font-semibold">Protecting our users' financial data with state-of-the-art security measures</p>
                            </div>
                            <div className=" text-white bg-zinc-400 rounded-xl p-4 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 h-fit mb-4 space-y-2">
                                <h2 className="font-bold text-lg">Accessibility</h2>
                                <p className="text-sm font-semibold">Making modern banking solutions available to everyone, everywhere</p>
                            </div>
                        </div>
                    </div>
                </div>

        ...
        <>
            <div className="flex flex-col items-center align-center justify-center my-12">
                ...
                <div className="text-white font-semibold text-2xl tracking-wide space-y-8">
                    <h3>Choose the perfect plan for your financial needs.</h3>
                </div>
            </div>
            <div className="flex justify-center m-12 space-x-12">
                <div className="flex flex-col mt-16 w-120 h-120 bg-zinc-300 rounded-3xl py-8 px-14 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 hover:-translate-y-4 duration-300">
                ...
                <div className="flex flex-col mt-16 w-120 h-120 bg-zinc-300 rounded-3xl py-8 px-14 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 hover:-translate-y-4 duration-300 border-2 border-pink-400">
